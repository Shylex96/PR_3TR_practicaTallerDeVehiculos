		...
		// --- If user click on accept button ---
			...
			// --- Check if "txtTelefonoCliente" AND "txtEmailCliente" has empty fields ---
				...
				if (txtEmailCliente.getText().matches("^[A-Za-z0-9]+@[A-Za-z0-9.-]+\\.[A-Za-z]{2,}$")) {
					...
					valorDialogo = 2;
					lblAviso.setText("El email introducido tiene formato no válido.");
					dlgWindow.setVisible(true);
				}
			}
				...
				if(txtTelefonoCliente.getText().matches("^[0-9]{9}") && txtEmailCliente.getText().matches("^[A-Za-z0-9]+@[A-Za-z0-9.-]+\\.[A-Za-z]{2,}$") ) {
					...
					valorDialogo = 2;
					lblAviso.setText("Los campos de email y teléfono son erróneos.");
					dlgWindow.setVisible(true);
					...
					// Phone is wrong
					valorDialogo = 2;
					lblAviso.setText("El teléfono introducido es erróneo.");
					dlgWindow.setVisible(true);
					...
					// Email is wrong
					valorDialogo = 2;
					lblAviso.setText("El email introducido es erróneo.");
					dlgWindow.setVisible(true);
				}
			}
		}
